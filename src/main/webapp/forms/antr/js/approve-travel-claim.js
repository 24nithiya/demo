...
console.log(date);
      ...
      success: function(data)  {
        ...
        document.getElementById("department").value=data.name;
            ...
            success: function(data)  {
              ...
              console.log("FURTHER MANAGER ID "+data.reportTo);
 ...
 $.ajax({
            ...
            url: url.empData+data.reportTo,//need to make generic
            type: "GET",
            dataType: "json",
            async: true,
            success: function(data)  {
                 ...
                 //   alert(data.firstName);
                    ...
                    furtherManagerLoginName=data.loginId;
                   // alert(empLoginId);
                }
...
var employeeId=get_data.application.employee.employeeId;
...
his.eventDescritption="approval_tavel";
...
/*json.actnowInterval=action;*/
    ...
    json.actnowInterval.applicationStatus=act_id;
var assignee="";
    if(act_id=="EMPLOYEEREVIEW")
    {
      assignee=empLoginId;
    }
    else if(act_id=="NEEDAPPROVAL"){
      assignee=furtherManagerLoginName;
    }
    else{
      assignee="";
    }
    json.actnowInterval.assignee=assignee;
