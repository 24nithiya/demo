        ...
        // alert(emp_id);
          ...
          console.log(expanse);
            ...
            $(data.application.notes).each(function(i){
                ...
                $(data.application.referenceDocuments).each(function(i,v){
              console.log("START DOCUMENT DATA "+data.application.referenceDocuments[i].locationUri);
...
his.remarks="<b>"+ act_id+"</b> -by-<b>"+$("#fsname").val()+"</b><br><b>Remarks:-</b>"+remarks+"" ;
