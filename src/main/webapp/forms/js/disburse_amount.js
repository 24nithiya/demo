...
var empIdForBank=$("#number").val();

var bank_dat="";
$.ajax({

            url:url.bankAccount+empIdForBank,//need to make generic
            type: "GET",
           // dataType: "json",
            async: true,
...
if(actions[i].queueName=="ClaimDisburse")
{
  act=true;
...
his.eventDescritption="claim_disburse";
