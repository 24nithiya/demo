...
var uuid;
  ...
  dat.id="1";
  dat.empId="114";
  dat.accountName="Rajanish";
  dat.accountNumber="1234545678";
  dat.bankName="AXIS";
  dat.branchName="HSR Layout";
  dat.branchCode="12345";
  dat.swiftIfsc="ICICI00012345";
  dat.address="HSR Layout, Bengaluru, Karnataka";
  bank_dat.push(dat);
...
var dat2={};
  dat2.id="2";
  dat2.empId="114";
  dat2.accountName="Rajanish";
  dat2.accountNumber="1234545678";
  dat2.bankName="STATE BANK OF INDIA";
  dat2.branchName="HSR Layout";
  dat2.branchCode="12345";
  dat2.swiftIfsc="ICICI00012345";
  dat2.address="HSR Layout, Bengaluru, Karnataka";
  bank_dat.push(dat2);
 ...
 var dat=date+" "+DisplayCurrentTime();
  ...
  $.ajax({
             ...
             //  alert(tRequestId+tStartDate+tEndDate+travelMode+travelClass+claimType);
                document.getElementById("trId").value=tRequestId;
...
var k=0;
$(document).on("click",".addExpance",function(){
  var  tab="<tr id='addExpance"+k+"'><td><input type='text' class='form-control' style='background:white,color:black' value='' ></td><td><input type='text' class='form-control' style='background:white,color:black' value='' ></td><td><input type='text' class='form-control' style='background:white,color:black' value='' ></td><td><input type='file' class='form-control' style='background:white,color:black' id='filename"+k+"' value='' ></td><td><button type='button' class='btn btn-primary' id='"+ k +"' onclick='viewFileInput(this.id)'>upload</button>&nbsp;&nbsp;<button type='button' class='btn btn-success addExpance' >+</button>&nbsp;&nbsp;<button type='button' class='btn btn-warning removeExpance' id='_"+k+"' >-</button></td></tr>";
    $("#rows_tab").append(tab);
  k++;
...
$(document).on("click",".removeExpance",function(){
 var id=$(this).attr("id");
 var index=id.split("_")
 //console.log(index[1]);
// alert($(this).attr("id"));
$("#addExpance"+index[1]+"").remove();
//console.log(id);
});
...
json.travelActual.bankAcId=$(".getBank").attr("id");
...
his.eventDescritption="claim_approval";
