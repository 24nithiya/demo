@media ( min-width :768px) {
	.form-inline .combobox-container, .form-search .combobox-container {
		display: inline-block;
		margin-bottom: 0;
		vertical-align: top
	}
	.form-inline .combobox-container .input-group-addon, .form-search .combobox-container .input-group-addon
		{
		width: auto
	}
}
...
.datepicker table tr td.highlighted.active.focus, .datepicker table tr td.highlighted.active:focus,
	...
	.open>.dropdown-toggle.datepicker table tr td.highlighted.focus, .open>.dropdown-toggle.datepicker table tr td.highlighted:focus,
...
.datepicker table tr td.today.active.focus, .datepicker table tr td.today.active:focus,
	...
	.open>.dropdown-toggle.datepicker table tr td.today.focus, .open>.dropdown-toggle.datepicker table tr td.today:focus,
...
.datepicker table tr td.range.active.focus, .datepicker table tr td.range.active:focus,
	...
	.open>.dropdown-toggle.datepicker table tr td.range.focus, .open>.dropdown-toggle.datepicker table tr td.range:focus,
...
.datepicker table tr td.range.today.active.focus, .datepicker table tr td.range.today.active:focus,
	...
	.open>.dropdown-toggle.datepicker table tr td.range.today.focus, .open>.dropdown-toggle.datepicker table tr td.range.today:focus,
...
.datepicker table tr td.selected.active, .datepicker table tr td.selected.highlighted.active,
	.datepicker table tr td.selected.highlighted:active, .datepicker table tr td.selected:active,
...
.datepicker table tr td.selected.active.focus, .datepicker table tr td.selected.active:focus,
	...
	.open>.dropdown-toggle.datepicker table tr td.selected.focus, .open>.dropdown-toggle.datepicker table tr td.selected.highlighted.focus,
	.open>.dropdown-toggle.datepicker table tr td.selected.highlighted:focus,
	.open>.dropdown-toggle.datepicker table tr td.selected.highlighted:hover,
	.open>.dropdown-toggle.datepicker table tr td.selected:focus, .open>.dropdown-toggle.datepicker table tr td.selected:hover
	{
	color: #fff;
...
.datepicker table tr td.active.active.focus, .datepicker table tr td.active.active:focus,
	...
	.open>.dropdown-toggle.datepicker table tr td.active.focus, .open>.dropdown-toggle.datepicker table tr td.active.highlighted.focus,
	.open>.dropdown-toggle.datepicker table tr td.active.highlighted:focus,
	.open>.dropdown-toggle.datepicker table tr td.active.highlighted:hover,
	.open>.dropdown-toggle.datepicker table tr td.active:focus, .open>.dropdown-toggle.datepicker table tr td.active:hover
	{
	color: #fff;
...
.datepicker table tr td span.active.active, .datepicker table tr td span.active.disabled.active,
	...
	.open>.dropdown-toggle.datepicker table tr td span.active, .open>.dropdown-toggle.datepicker table tr td span.active.disabled,
...
.datepicker table tr td span.active.active.focus, .datepicker table tr td span.active.active:focus,
	...
	.datepicker table tr td span.active:hover:active:hover, .open>.dropdown-toggle.datepicker table tr td span.active.disabled.focus,
	.open>.dropdown-toggle.datepicker table tr td span.active.disabled:focus,
	.open>.dropdown-toggle.datepicker table tr td span.active.disabled:hover,
	.open>.dropdown-toggle.datepicker table tr td span.active.disabled:hover.focus,
	.open>.dropdown-toggle.datepicker table tr td span.active.disabled:hover:focus,
	.open>.dropdown-toggle.datepicker table tr td span.active.disabled:hover:hover,
	.open>.dropdown-toggle.datepicker table tr td span.active.focus, .open>.dropdown-toggle.datepicker table tr td span.active:focus,
	.open>.dropdown-toggle.datepicker table tr td span.active:hover, .open>.dropdown-toggle.datepicker table tr td span.active:hover.focus,
...
.datepicker table tr td span.active .badge, .datepicker table tr td span.active.disabled .badge,
	.datepicker table tr td span.active.disabled:hover .badge, .datepicker table tr td span.active:hover .badge
	{
	color: #0088ce;
	background-color: #fff
}
...
.applauncher-pf .applauncher-pf-link-icon, .applauncher-pf .applauncher-pf-link-title
	{
	display: inline-block;
	vertical-align: middle
}

.applauncher-pf.applauncher-pf-block-list .applauncher-pf-item {
	display: inline-block;
	min-width: 0;
	text-align: center;
	vertical-align: top;
...
@media ( min-width :768px) {
	.applauncher-pf.applauncher-pf-block-list .applauncher-pf-link {
		padding: 15px 10px
	}
}

.applauncher-pf.applauncher-pf-block-list .applauncher-pf-link-icon,
	.applauncher-pf.applauncher-pf-block-list .applauncher-pf-link-title {
	display: block;
	padding: 0;
	width: auto
}
...
.navbar-pf .applauncher-pf, .navbar-pf .navbar-utility .applauncher-pf,
	.navbar-pf-alt .applauncher-pf, .navbar-pf-alt .navbar-utility .applauncher-pf
	{
	display: block;
	overflow: hidden
}

.navbar-pf .applauncher-pf>a:hover, .navbar-pf .navbar-utility .applauncher-pf>a:hover,
	.navbar-pf-alt .applauncher-pf>a:hover, .navbar-pf-alt .navbar-utility .applauncher-pf>a:hover
	{
	background-color: #232323
}

.navbar-pf .applauncher-pf.open>a, .navbar-pf .applauncher-pf.open>a:focus,
	.navbar-pf .navbar-utility .applauncher-pf.open>a, .navbar-pf .navbar-utility .applauncher-pf.open>a:focus,
	.navbar-pf-alt .applauncher-pf.open>a, .navbar-pf-alt .applauncher-pf.open>a:focus,
	.navbar-pf-alt .navbar-utility .applauncher-pf.open>a, .navbar-pf-alt .navbar-utility .applauncher-pf.open>a:focus
	{
	background-color: #232323;
	color: #f5f5f5
}
...
.navbar-pf .applauncher-pf .dropdown-menu, .navbar-pf .navbar-utility .applauncher-pf .dropdown-menu,
	.navbar-pf-alt .applauncher-pf .dropdown-menu, .navbar-pf-alt .navbar-utility .applauncher-pf .dropdown-menu
	{
...
.navbar-pf .applauncher-pf .dropdown-toggle, .navbar-pf .applauncher-pf.dropdown>.dropdown-toggle,
	.navbar-pf .navbar-utility .applauncher-pf .dropdown-toggle, .navbar-pf .navbar-utility .applauncher-pf.dropdown>.dropdown-toggle,
	.navbar-pf-alt .applauncher-pf .dropdown-toggle, .navbar-pf-alt .applauncher-pf.dropdown>.dropdown-toggle,
...
.navbar-pf .applauncher-pf .dropdown-toggle.disabled, .navbar-pf .applauncher-pf.dropdown>.dropdown-toggle.disabled,
...
.navbar-pf .applauncher-pf .applauncher-pf-icon, .navbar-pf .navbar-utility .applauncher-pf .applauncher-pf-icon,
	.navbar-pf-alt .applauncher-pf .applauncher-pf-icon, .navbar-pf-alt .navbar-utility .applauncher-pf .applauncher-pf-icon
	{
	padding-right: 4px
}
...
.navbar-pf .applauncher-pf .applauncher-pf-title, .navbar-pf .navbar-utility .applauncher-pf .applauncher-pf-title,
	.navbar-pf-alt .applauncher-pf .applauncher-pf-title, .navbar-pf-alt .navbar-utility .applauncher-pf .applauncher-pf-title
	{
	display: inline;
	position: relative
}

.navbar-pf .applauncher-pf .applauncher-pf-item, .navbar-pf .navbar-utility .applauncher-pf .applauncher-pf-item,
	.navbar-pf-alt .applauncher-pf .applauncher-pf-item, .navbar-pf-alt .navbar-utility .applauncher-pf .applauncher-pf-item
	{
	display: block;
	min-width: inherit;
	text-align: left;
...
.navbar-pf .applauncher-pf .applauncher-pf-link, .navbar-pf .navbar-utility .applauncher-pf .applauncher-pf-link,
	.navbar-pf-alt .applauncher-pf .applauncher-pf-link, .navbar-pf-alt .navbar-utility .applauncher-pf .applauncher-pf-link
	{
	overflow: hidden;
	width: 100%
}

.navbar-pf .applauncher-pf .applauncher-pf-link:hover, .navbar-pf .navbar-utility .applauncher-pf .applauncher-pf-link:hover,
...
.navbar-pf .applauncher-pf .applauncher-pf-link-icon, .navbar-pf .navbar-utility .applauncher-pf .applauncher-pf-link-icon,
...
.navbar-pf .applauncher-pf .applauncher-pf-link-title, .navbar-pf .navbar-utility .applauncher-pf .applauncher-pf-link-title,
...
@media ( min-width :768px) {
	...
	.navbar-pf .applauncher-pf .dropdown-toggle.disabled, .navbar-pf .navbar-utility .applauncher-pf .dropdown-toggle.disabled,
		.navbar-pf-alt .applauncher-pf .dropdown-toggle.disabled,
		.navbar-pf-alt .navbar-utility .applauncher-pf .dropdown-toggle.disabled
		{
		cursor: not-allowed
	...
	.navbar-pf .applauncher-pf .applauncher-pf-link-icon, .navbar-pf .applauncher-pf .applauncher-pf-link-title,
	...
	.navbar-pf .applauncher-pf.applauncher-pf-block-list .applauncher-pf-item,
		.navbar-pf .navbar-utility .applauncher-pf.applauncher-pf-block-list .applauncher-pf-item,
		.navbar-pf-alt .applauncher-pf.applauncher-pf-block-list .applauncher-pf-item,
		.navbar-pf-alt .navbar-utility .applauncher-pf.applauncher-pf-block-list .applauncher-pf-item
		{
		display: inline-block;
		min-width: 0;
		text-align: center;
	...
	.navbar-pf .applauncher-pf.applauncher-pf-block-list .applauncher-pf-link-icon,
		.navbar-pf .applauncher-pf.applauncher-pf-block-list .applauncher-pf-link-title,
		.navbar-pf .navbar-utility .applauncher-pf.applauncher-pf-block-list .applauncher-pf-link-icon,
		.navbar-pf .navbar-utility .applauncher-pf.applauncher-pf-block-list .applauncher-pf-link-title,
		.navbar-pf-alt .applauncher-pf.applauncher-pf-block-list .applauncher-pf-link-icon,
		.navbar-pf-alt .applauncher-pf.applauncher-pf-block-list .applauncher-pf-link-title,
		.navbar-pf-alt .navbar-utility .applauncher-pf.applauncher-pf-block-list .applauncher-pf-link-icon,
		.navbar-pf-alt .navbar-utility .applauncher-pf.applauncher-pf-block-list .applauncher-pf-link-title
		{
		display: block;
		padding: 0;
		width: auto
...
@media ( min-width :768px) and (min-width:768px) {
	.navbar-pf .applauncher-pf.applauncher-pf-block-list .applauncher-pf-link,
		.navbar-pf .navbar-utility .applauncher-pf.applauncher-pf-block-list .applauncher-pf-link,
		.navbar-pf-alt .applauncher-pf.applauncher-pf-block-list .applauncher-pf-link,
		.navbar-pf-alt .navbar-utility .applauncher-pf.applauncher-pf-block-list .applauncher-pf-link
		{
		padding: 15px 10px
	}
}
...
@media ( min-width :768px) {
	.navbar-iconic .applauncher-pf .dropdown-toggle, .navbar-iconic .applauncher-pf.dropdown>.dropdown-toggle,
...
.combobox-container .input-group-addon.active, .combobox-container .input-group-addon:active,
	.combobox-container .input-group-addon:focus, .combobox-container .input-group-addon:hover,
...
.combobox-container .input-group-addon.active.focus, .combobox-container .input-group-addon.active:focus,
	.combobox-container .input-group-addon.active:hover,
	.combobox-container .input-group-addon:active.focus,
	.combobox-container .input-group-addon:active:focus,
	.combobox-container .input-group-addon:active:hover, .open .dropdown-toggle.combobox-container .input-group-addon.focus,
...
.combobox-container .input-group-addon.disabled, .combobox-container .input-group-addon.disabled.active,
	...
	.combobox-container .input-group-addon[disabled]:active,
	.combobox-container .input-group-addon[disabled]:focus,
	.combobox-container .input-group-addon[disabled]:hover, fieldset[disabled] .combobox-container .input-group-addon,
...
.bootstrap-datepicker.form-control[readonly] {
	...
	color: #363636;
	box-shadow: inset 0 1px 1px rgba(3, 3, 3, .075)
}
...
.has-error .bootstrap-datepicker.form-control[readonly]:focus {
	border-color: #900;
	box-shadow: inset 0 1px 1px rgba(3, 3, 3, .075), 0 0 6px #f33
}

.has-success .bootstrap-datepicker.form-control[readonly]:focus {
	border-color: #2b542c;
	box-shadow: inset 0 1px 1px rgba(3, 3, 3, .075), 0 0 6px #67b168
}

.has-warning .bootstrap-datepicker.form-control[readonly]:focus {
	border-color: #bb6106;
	box-shadow: inset 0 1px 1px rgba(3, 3, 3, .075), 0 0 6px #faad60
}
...
.datepicker .datepicker-switch, .datepicker tfoot .clear, .datepicker tfoot .today
	{
	font-size: 14px;
	font-weight: 500
}
...
.bootstrap-select.btn-group .btn:focus {
	border-color: #0088ce;
	outline: 0 !important;
	box-shadow: inset 0 1px 1px rgba(3, 3, 3, .075), 0 0 8px
		rgba(0, 136, 206, .6)
}
...
.bootstrap-switch .bootstrap-switch-label {
	background: #f1f1f1;
	box-shadow: 0 0 2px rgba(3, 3, 3, .4);
	background-image: linear-gradient(to bottom, #fafafa 0, #ededed 100%);
	background-repeat: repeat-x;
	position: relative;
	z-index: 9
...
.treeview .list-group-item.node-check-changed span.node-icon, .treeview .list-group-item.node-check-changed span.text
	{
	color: #39a5dc
}
...
.card-pf-footer a .fa, .card-pf-footer a .pficon {
	margin-right: 5px
}
...
.card-pf-link-with-icon .fa, .card-pf-link-with-icon .pficon {
	font-size: 16px;
	left: 0;
	position: absolute;
	top: 0
...
.card-pf-footer .card-pf-time-frame-filter, .card-pf-heading .card-pf-time-frame-filter
	{
	float: right;
	margin-left: 20px
}
...
.card-pf-aggregate-status .card-pf-title .fa, .card-pf-aggregate-status .card-pf-title .pficon
	{
	color: #292e34;
	font-size: 16px;
	margin-right: 7px
...
.card-pf-view .card-pf-item .fa+.card-pf-item-text, .card-pf-view .card-pf-item .pficon+.card-pf-item-text
	{
	margin-left: 10px
}
...
.card-pf-view .card-pf-title .fa, .card-pf-view .card-pf-title .pficon {
	font-size: 18px;
	margin-right: 2px
}
...
.card-pf-view.card-pf-view-xs .card-pf-title .fa, .card-pf-view.card-pf-view-xs .card-pf-title .pficon
	{
	font-size: 14px;
	margin-right: 5px
}
...
.c3-tooltip-sparkline, .donut-tooltip-pf {
	background: #393f44;
	color: #fff;
	opacity: .9;
	padding: 2px 6px
...
.layout-pf-alt-fixed-with-footer .footer-pf,
	...
	.layout-pf-fixed-with-footer .footer-pf, .layout-pf-fixed-with-footer .footer-pf-alt
	{
	bottom: 0;
	left: 0;
	position: fixed;
...
@font-face {
	...
	src: url(../fonts/PatternFlyIcons-webfont.eot?#iefix)
		format("embedded-opentype"), url(../fonts/PatternFlyIcons-webfont.ttf)
		format("truetype"), url(../fonts/PatternFlyIcons-webfont.woff)
		format("woff"),
...
.pficon-flag:before, .pficon-messages:before {
	content: "\e603"
}
...
.pficon-refresh:before, .pficon-restart:before {
	content: "\e617"
}
...
.infotip.bottom .arrow, .infotip.bottom-left .arrow, .infotip.bottom-right .arrow
	{
...
.infotip.bottom .arrow:after, .infotip.bottom-left .arrow:after,
...
.layout-pf-alt, .layout-pf-alt body {
	min-height: 100%
}
...
.list-pf-chevron .fa, .list-pf-select .fa {
	font-size: 22px
}
...
.list-view-pf .list-group-item:after, .list-view-pf .list-group-item:before
	{
	content: " ";
	display: table
}
...
.list-view-pf-actions .dropdown-kebab-pf, .list-view-pf-actions button,
...
.list-view-pf-left .fa, .list-view-pf-left .pficon {
	border-radius: 50%;
	font-size: 2em
}

.list-view-pf-left .fa.list-view-pf-icon-md, .list-view-pf-left .pficon.list-view-pf-icon-md
	{
	background-color: #f5f5f5;
	height: 50px;
	line-height: 50px;
...
.list-view-pf-left .fa.list-view-pf-icon-danger, .list-view-pf-left .pficon.list-view-pf-icon-danger
	{
	background-color: #ffe6e6;
	color: #c00
}

.list-view-pf-left .fa.list-view-pf-icon-info, .list-view-pf-left .pficon.list-view-pf-icon-info
	{
	color: #8b8d8f
}

.list-view-pf-left .fa.list-view-pf-icon-lg, .list-view-pf-left .pficon.list-view-pf-icon-lg
	{
	background-color: #f5f5f5;
	height: 60px;
	line-height: 60px;
...
.list-view-pf-left .fa.list-view-pf-icon-sm, .list-view-pf-left .pficon.list-view-pf-icon-sm
	{
	border: 2px solid #39a5dc;
	font-size: 1.4em;
	height: 30px;
...
.list-view-pf-left .fa.list-view-pf-icon-sm:before, .list-view-pf-left .pficon.list-view-pf-icon-sm:before
	{
	display: block;
	line-height: 26px
}

.list-view-pf-left .fa.list-view-pf-icon-success, .list-view-pf-left .pficon.list-view-pf-icon-success
	{
	background-color: #e9f4e9;
	color: #3f9c35
}

.list-view-pf-left .fa.list-view-pf-icon-warning, .list-view-pf-left .pficon.list-view-pf-icon-warning
	{
...
.navbar-pf .navbar-nav>.active>a, .navbar-pf .navbar-nav>.active>a:focus,
...
.navbar-pf .navbar-nav>.open>a, .navbar-pf .navbar-nav>.open>a:focus,
...
@media ( max-width :767px) {
	.navbar-pf .navbar-nav .active .dropdown-menu, .navbar-pf .navbar-nav .active .navbar-persistent,
	...
	.navbar-pf .navbar-nav .active .dropdown-menu .dropdown-submenu.open>a,
		...
		.navbar-pf .navbar-nav .active .dropdown-menu>.active>a, .navbar-pf .navbar-nav .active .dropdown-menu>.active>a:focus,
		...
		.navbar-pf .navbar-nav .open .dropdown-menu>.active>a, .navbar-pf .navbar-nav .open .dropdown-menu>.active>a:focus,
		.navbar-pf .navbar-nav .open .dropdown-menu>.active>a:hover {
		background-color: #1f1f1f !important;
		color: #f5f5f5
	}
	.navbar-pf .navbar-nav .active .dropdown-menu>li>a, .navbar-pf .navbar-nav .active .navbar-persistent>li>a,
	...
	.navbar-pf .navbar-nav .active .dropdown-menu>li>a:hover, .navbar-pf .navbar-nav .active .navbar-persistent>li>a:hover,
		.navbar-pf .navbar-nav .open .dropdown-menu>li>a:hover {
		color: #f5f5f5
	}
	.navbar-pf .navbar-nav .active .dropdown-menu .divider, .navbar-pf .navbar-nav .active .navbar-persistent .divider,
...
.navbar-pf .navbar-toggle:focus, .navbar-pf .navbar-toggle:hover {
	background-color: transparent;
	outline: 0
}

.navbar-pf .navbar-toggle:focus .icon-bar, .navbar-pf .navbar-toggle:hover .icon-bar
	{
...
@media ( min-width :768px) {
	...
	.navbar-pf .navbar-utility>.active>a, .navbar-pf .navbar-utility>.active>a:focus,
		.navbar-pf .navbar-utility>.active>a:hover, .navbar-pf .navbar-utility>.open>a,
		.navbar-pf .navbar-utility>.open>a:focus, .navbar-pf .navbar-utility>.open>a:hover
		{
		background: #363636;
		color: #d1d1d1
	}
	...
	.navbar-pf .open .dropdown-submenu>.dropdown-menu, .navbar-pf .open.bootstrap-select .dropdown-menu
		{
		border-top-width: 1px !important
	}
}
...
.navbar-pf-alt .nav .nav-item-iconic:focus, .navbar-pf-alt .nav .nav-item-iconic:hover
	{
	background-color: transparent
}

.navbar-pf-alt .nav .nav-item-iconic:focus .caret, .navbar-pf-alt .nav .nav-item-iconic:focus .fa,
	.navbar-pf-alt .nav .nav-item-iconic:focus .glyphicon, .navbar-pf-alt .nav .nav-item-iconic:focus .pficon,
	.navbar-pf-alt .nav .nav-item-iconic:hover .caret, .navbar-pf-alt .nav .nav-item-iconic:hover .fa,
	.navbar-pf-alt .nav .nav-item-iconic:hover .glyphicon, .navbar-pf-alt .nav .nav-item-iconic:hover .pficon
	{
	color: #fff
}
...
.navbar-pf-alt .nav .nav-item-iconic .caret, .navbar-pf-alt .nav .nav-item-iconic .fa,
...
.navbar-pf-alt .nav .open>.nav-item-iconic, .navbar-pf-alt .nav .open>.nav-item-iconic:focus,
	.navbar-pf-alt .nav .open>.nav-item-iconic:hover {
	background: 0 0
}

.navbar-pf-alt .nav .open>.nav-item-iconic .caret, .navbar-pf-alt .nav .open>.nav-item-iconic .fa,
	.navbar-pf-alt .nav .open>.nav-item-iconic .pficon, .navbar-pf-alt .nav .open>.nav-item-iconic:focus .caret,
	.navbar-pf-alt .nav .open>.nav-item-iconic:focus .fa, .navbar-pf-alt .nav .open>.nav-item-iconic:focus .pficon,
	.navbar-pf-alt .nav .open>.nav-item-iconic:hover .caret, .navbar-pf-alt .nav .open>.nav-item-iconic:hover .fa,
...
.navbar-pf-alt .navbar-toggle:focus .icon-bar, .navbar-pf-alt .navbar-toggle:hover .icon-bar
	{
	background: #fff
}
...
.navbar-pf-vertical .nav .nav-item-iconic:focus, .navbar-pf-vertical .nav .nav-item-iconic:hover
	{
	color: #fff;
	background-color: transparent
}
...
.navbar-pf-vertical .nav .nav-item-iconic .caret, .navbar-pf-vertical .nav .nav-item-iconic .fa,
...
.navbar-pf-vertical .nav .open>.nav-item-iconic, .navbar-pf-vertical .nav .open>.nav-item-iconic:focus,
...
.navbar-pf-vertical .navbar-brand .navbar-brand-icon {
	/* display: inline-block;
	margin: 0 15px 0 0
	margin: -23px -127px -11px 58px;
	width: 100px;
	height: 37px; */
	display: inline-block;
   
    margin: -18px -115px -10px 47px;
    width: 80px;
    height: 35px;
}
...
.navbar-pf-vertical .navbar-toggle:focus .icon-bar, .navbar-pf-vertical .navbar-toggle:hover .icon-bar
	{
	background: #fff
}
...
.layout-pf-alt-fixed .nav-pf-vertical-alt.hidden.show-mobile-nav {
	box-shadow: 0 0 3px rgba(3, 3, 3, .15);
	display: block !important
}
...
.nav-pf-vertical-alt .list-group-item .fa, .nav-pf-vertical-alt .list-group-item .glyphicon,
...
.drawer-pf-toggle-expand:focus, .drawer-pf-toggle-expand:hover {
	color: inherit;
	text-decoration: none
}
...
.drawer-pf-notification-info, .drawer-pf-notification-message {
	display: block;
	padding-left: 27px;
	padding-right: 19px
}
...
@media ( min-width :767px) {
	...
	.sidebar-pf .panel-group .panel-default, .sidebar-pf .treeview {
		border-left: 0;
		border-right: 0;
		margin-left: -20px;
		margin-right: -20px
...
@media ( min-width :768px) {
	...
	.sidebar-pf>.nav-category, .sidebar-pf>.nav-stacked {
		margin-top: 5px
	}
}
...
.spinner {
	...
	border-bottom: 4px solid rgba(3, 3, 3, .25);
	border-left: 4px solid rgba(3, 3, 3, .25);
	border-right: 4px solid rgba(3, 3, 3, .25);
	border-radius: 100%;
	border-top: 4px solid rgba(3, 3, 3, .75);
	height: 24px;
	margin: 0 auto;
	position: relative;
	width: 24px
...
.prettyprint .atn, .prettyprint .com, .prettyprint .fun, .prettyprint .var
	{
	color: #3f9c35
}
...
.prettyprint .clo, .prettyprint .dec, .prettyprint .kwd, .prettyprint .opn,
	.prettyprint .pln, .prettyprint .pun {
	color: #363636
}

.prettyprint .lit, .prettyprint .tag, .prettyprint .typ {
	color: #00659c
}
...
.timepicker-hours table td, .timepicker-minutes table td {
	font-weight: 700;
	line-height: 30px;
	height: 30px
}

.timepicker-hours table td:hover, .timepicker-minutes table td:hover {
	color: #0088ce
}

.timepicker-hours .table-condensed>tbody>tr>td, .timepicker-minutes .table-condensed>tbody>tr>td
	{
	padding: 0
}

.time-picker-pf .input-group-addon .fa, .time-picker-pf .input-group-addon .pficon
	{
	width: 12px
}
...
.timepicker-picker table td a span, .timepicker-picker table td span {
	height: 24px;
	line-height: 24px;
	margin: 0;
	width: 100%
...
.toast-pf>.pficon {
	...
	bottom: -1px;
	box-shadow: 2px 0 5px -2px rgba(3, 3, 3, .2);
	left: -1px;
	padding-top: 10px;
	text-align: center;
	top: -1px;
...
.toolbar-pf .form-group .btn+.btn, .toolbar-pf .form-group .btn+.btn-group,
	.toolbar-pf .form-group .btn-group+.btn, .toolbar-pf .form-group .btn-group+.btn-group
	{
	margin-left: 5px
}

.toolbar-pf .form-group .btn+.btn-link, .toolbar-pf .form-group .btn+.dropdown,
	.toolbar-pf .form-group .btn-group+.btn-link, .toolbar-pf .form-group .btn-group+.dropdown
	{
	margin-left: 10px
}
...
.toolbar-pf .form-group .btn-link:active, .toolbar-pf .form-group .btn-link:focus,
...
.find-pf-dropdown-container:after, .find-pf-dropdown-container:before {
	content: "";
	position: absolute
}
...
@
supports (display:flex ){ . nav-pf-vertical .list-group-item>a {
	display: -ms-flexbox;
	display: flex;
	padding-right: 0
}
...
.nav-pf-vertical .list-group-item>a .fa, .nav-pf-vertical .list-group-item>a .glyphicon,
...
.nav-pf-vertical .list-group-item.active>a .fa, .nav-pf-vertical .list-group-item.active>a .glyphicon,
	.nav-pf-vertical .list-group-item.active>a .pficon, .nav-pf-vertical .list-group-item:hover>a .fa,
	.nav-pf-vertical .list-group-item:hover>a .glyphicon, .nav-pf-vertical .list-group-item:hover>a .pficon
	{
	color: #39a5dc
}
...
@
supports (display:flex ){ .nav-pf-vertical .list-group-item
...
@
supports (display:flex ){ . nav-pf-vertical .badge-container-pf {
	padding-left: 0;
	padding-right: 15px;
	position: relative;
	right: 0;
...
.nav-pf-vertical .badge-container-pf .badge .fa, .nav-pf-vertical .badge-container-pf .badge .pficon
	{
	font-size: 14px;
	height: 20px;
	line-height: 1.66666667;
...
@
supports (display:flex ){ .secondary-nav-item-pf>a
	.list-group-item-value {
	padding-right: 35px
}
...
.nav-item-pf-header>a:focus, .nav-item-pf-header>a:hover {
	color: #0088ce;
	text-decoration: none
}
...
@
supports (display:flex ){ .nav-pf-secondary-nav
	.list-group-item.tertiary-nav-item-pf>a
	.list-group-item-value {
	padding-right: 35px
}
